...
class PacManGame:
    ...
    def start_game(self):
        ...
        while running:
            ...
            pygame.draw.circle(screen, "gold", (int(self.WIDTH//2) - 10, int(self.HEIGHT//2) - 50), 10)
            ...
            blinky = RedGhost(self.blinky_x, self.blinky_y, self.blinky_direction, self.blinky_img, self.blinky_dead,
                              ...
                              self.img_dead, target_x_b, target_y_b, pacman_rect)
